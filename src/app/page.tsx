...
const cards = [
  ...
  { n: 5, href: "/music", icon: "Music", color: "#c99a34", title: "Worshiping Christ through Music", body: "Lift our voices and hearts in sacred music that honors Jesus Christ.", img: "/images/h2-c5.jpg" },
...
export default function HomePage() {
  return (
    <>
      {/* Hero — clean banner, straight edge (matches the reference) */}
      <section className="border-b border-border bg-white dark:bg-bg">
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img src="/images/h2-hero.jpg" alt="Come, O Thou King of Kings — United in Christ, strengthened by Scripture, gathered in love" className="block w-full select-none" width={1024} height={288} />
      </section>
          ...
          <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-3">
            {cards.map((c) => (
              <Link
                key={c.n}
                href={c.href}
                className="group flex flex-col rounded-2xl border border-border bg-white p-5 shadow-sm transition-all hover:-translate-y-1 hover:shadow-lg dark:bg-surface"
              >
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="font-serif text-lg font-bold leading-tight" style={{ color: c.color }}>
